...
export default class IntakeCoList extends React.Component{
    constructor(props){
        super(props);
    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <IconAnt name="left" size={20} color='#A4A4A4' style={{marginRight:5}}/>
        ...
        <Text style={{fontSize:18,marginLeft:26,marginTop:17,fontWeight:'700',color:'#141414'}}>Intake Coordinator List</Text> 
        </TouchableOpacity>
