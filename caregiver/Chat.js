      ...
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
          <View style={styles.inputContainer}>
            ...
            <TouchableOpacity onPress={()=>this.props.navigation.navigate('TotalClients')} style={styles.btnSend}>
            <IconAnt3 name="send-circle" size={40} color='white' style={{alignSelf:'center'}}/>
            </TouchableOpacity>
        </View>
      </View>
    );
