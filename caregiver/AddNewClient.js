...
render()
{
    ...
    if( assetsLoaded ) 
    {
      ...
      <View style={styles.container}>
       ...
       <TouchableOpacity onPress={()=>this.props.navigation.navigate('AddNewCareg')} >
       <Text style={{fontSize:16,marginLeft:20,marginTop:0,fontWeight:'600',color:'#141414'}}>Add New Client</Text>
       </TouchableOpacity>
       </View>
