...
export default class WeeklySurvery2 extends React.Component{
    constructor(props){
        super(props);
    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <Text style={{fontSize:18,marginLeft:80,marginTop:15,fontWeight:'600',color:'#FFFFFF'}}>Weekly Survey</Text>
        ...
        <Text style={{fontSize:14,textAlign:'center',marginTop:24,fontWeight:'600',color:'#A4A4A4',textTransform:'uppercase'}}>Question: 02</Text>
        ...
        <Item    style={{marginLeft:21,marginRight:15,marginTop:10,width:325,height:90,alignSelf:'center',borderColor:'#E2E2E2',borderRadius:4,borderWidth:1,textAlign:'left'}} regular>
          <Input placeholder=""
          ...
          <TouchableOpacity onPress={()=>this.props.navigation.navigate('WeeklySurvery3')} >
