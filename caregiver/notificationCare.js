...
export default class NotificationCare extends React.Component {
  ...
  getNotification = (value) => {
    console.log("getNotification", value);
    const url =
      "https://aplushome.facebhoook.com/api/getcaregivernotification/" + value;
    axios
      .get(
        "https://aplushome.facebhoook.com/api/getcaregivernotification/" + value
      )
