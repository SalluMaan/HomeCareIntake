    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <Text style={{fontSize:18,marginLeft:80,marginTop:15,fontWeight:'600',color:'#FFFFFF'}}>Weekly Survey</Text>
        ...
        <View style={{marginTop:-40,width:340,height:451,backgroundColor:'white',alignSelf:'center',borderColor:'#BEBEBEBA',borderRadius:10,borderWidth:1}}>
        <Text style={{fontSize:14,textAlign:'center',marginTop:24,fontWeight:'600',color:'#A4A4A4',textTransform:'uppercase'}}>Question: 03</Text>

          <Text style={{fontSize:15,marginTop:50,marginLeft:21,fontWeight:'600',color:'#434343'}}>How did you feel about the service?</Text>
    
          <View style={{marginTop:15,marginLeft:21}}>
             
             <View style={{marginLeft:0,flexDirection:'row'}}>
              <Radio selected={true}   />
              <Text style={{marginLeft:15,color:'blue',fontSize:14}}>Very Satisfied</Text>
              </View>
             
              <View style={{marginLeft:0,marginTop:10,flexDirection:'row'}}>
              <Radio selected={false}  style={{}}/>
              <Text style={{marginLeft:15,color:'#A4A4A4',fontSize:14}}>Neither Satisfied or Dissatisfied</Text>
              </View>

              <View style={{marginLeft:0,marginTop:10,flexDirection:'row'}}>
              <Radio selected={false}  style={{}}/>
              <Text style={{marginLeft:15,color:'#A4A4A4',fontSize:14}}>Dissatisfied</Text>
              </View>

              <View style={{marginLeft:0,marginTop:10,flexDirection:'row'}}>
              <Radio selected={false}  style={{}}/>
              <Text style={{marginLeft:15,color:'#A4A4A4',fontSize:14}}>Very Dissatisfied</Text>
              </View>
        </View> 
        ...
        <TouchableOpacity onPress={()=>this.props.navigation.navigate('WeeklySurvery4')} >
