...
export default class Schmake extends React.Component{
    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <IconAnt name="left" size={20} color='#A4A4A4' style={{marginRight:5}}/>
        ...
        <TouchableOpacity onPress={()=>this.props.navigation.navigate('Calander')} >
        <Text style={{fontSize:18,marginLeft:20,marginTop:23,fontWeight:'600',color:'#141414'}}>Assign New Schedule</Text>
        </TouchableOpacity>

        <View style={{width:334,height:173,backgroundColor:'#00000029',borderRadius:7,alignSelf:'center',marginTop:17}}>
           ...
           <Form>
            <Picker
              ...
              style={{ width:316,alignSelf:'center',backgroundColor:'white',marginTop:26,borderWidth:1,borderRadius:10,borderColor:'#E2E2E2' }}
        ...
        <View style={{width:334,height:183,backgroundColor:'#00000029',borderRadius:7,alignSelf:'center',marginTop:17}}>
      
        <Item  onPress={this.showDateTimePicker}  style={{backgroundColor:'white',marginLeft:15,marginRight:15,marginTop:23,width:320,height:50,alignSelf:'center',borderColor:'#E2E2E2',borderRadius:4,borderWidth:1,textAlign:'left'}} regular>
        ...
        />
          ...
          <Text style={{color:'#A4A4A4',marginLeft:20}}> 09:30 AM </Text>
           <IconAnt name="down" size={20} color='#A4A4A4' style={{marginLeft:5}}/>
          </Item >
          ...
          <Text style={{color:'#A4A4A4',marginLeft:15}}> 01:30 PM </Text>
           <IconAnt name="down" size={20} color='#A4A4A4' style={{marginLeft:10}}/>
          </Item >
          </View>
        </View>
