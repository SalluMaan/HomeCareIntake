...
export default class WeeklySurvery4 extends React.Component{
    constructor(props){
        super(props);
    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <Text style={{fontSize:18,marginLeft:80,marginTop:15,fontWeight:'600',color:'#FFFFFF'}}>Weekly Survey</Text>
        ...
        <View style={{marginTop:-40,width:340,height:330,backgroundColor:'white',alignSelf:'center',borderColor:'#BEBEBEBA',borderRadius:10,borderWidth:1}}>
        <Text style={{fontSize:14,textAlign:'center',marginTop:24,fontWeight:'600',color:'#A4A4A4',textTransform:'uppercase'}}>Question: 04</Text>

        <View style={{flexDirection:'row',alignSelf:'center',width:230}}>
        <Text style={{fontSize:18,textAlign:'center',marginTop:30,fontWeight:'600',color:'#434343'}}>Had trouble keeping my mind on what I was doing</Text>
        </View>
        ...
        <View style={{flexDirection:'row',backgroundColor:'white',marginTop:30,marginLeft:12,marginRight:10}}>
            ...
            <Text style={{marginLeft:30,fontSize:14,color:'#7D7D7D',marginTop:-3}}>Item_01</Text>
            <CheckBox checked={false} color="#FCC9D7"/>
            <Text style={{marginLeft:30,fontSize:14,color:'#7D7D7D',marginTop:-3}}>Item_02</Text>
            <CheckBox checked={false} color="#FCC9D7"/>
            <Text style={{marginLeft:30,fontSize:14,color:'#7D7D7D',marginTop:-3}}>Item_03</Text>
        </View>

        <View style={{flexDirection:'row',backgroundColor:'white',marginTop:30,marginLeft:12,marginRight:10}}>
            <CheckBox checked={false} color="#FCC9D7"/>
            <Text style={{marginLeft:30,fontSize:14,color:'#7D7D7D',marginTop:-3}}>Item_04</Text>
            <CheckBox checked={false} color="#FCC9D7"/>
            <Text style={{marginLeft:30,fontSize:14,color:'#7D7D7D',marginTop:-3}}>Item_05</Text>
        </View>
        ...
        <IconAnt2 name="primitive-dot" size={30} color='#FFC8D7' style={{marginTop:15,alignSelf:'center'}}/>
        <IconAnt2 name="primitive-dot" size={30} color='#FFC8D7' style={{marginTop:15,marginLeft:10, alignSelf:'center'}}/>
        <IconAnt2 name="primitive-dot" size={30} color='#FFC8D7' style={{marginTop:15,marginLeft:10, alignSelf:'center'}}/>
        <IconAnt2 name="primitive-dot" size={30} color='#FC3E73' style={{marginTop:15,marginLeft:10, alignSelf:'center'}}/>
        <IconAnt2 name="primitive-dot" size={30} color='#FFC8D7' style={{marginTop:15,marginLeft:10, alignSelf:'center'}}/>
