...
render()
{
    ...
    if( assetsLoaded ) 
    {
      ...
      <TouchableOpacity onPress={()=>this.props.navigation.navigate('SchDetComp')} >
     
        <Text style={{fontSize:12,marginLeft:260,marginTop:10,fontWeight:'600',color:'#141414',textTransform: 'uppercase'}}>Edit schedule</Text>
        </TouchableOpacity>
       ...
       <View>
        ...
        <Button   style={{marginTop:23,width:138,height:50,marginLeft:20,backgroundColor:'#B20838',borderRadius:4,borderWidth:1,textAlign:'center'}}> <IconAnt3 name="map-pin" size={15} color='white' style={{marginLeft:5}} /><Text>   </Text><Text style={{fontSize:16,marginLeft:5,fontWeight:'600',color:'white'}}>MAP</Text></Button>
        </View>
        </View>
