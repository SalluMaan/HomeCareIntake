...
render()
{
    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <TouchableOpacity onPress={()=>this.props.navigation.navigate('Meetings')} >  
       ...
       <IconAnt name="left" size={20} color='#A4A4A4' style={{marginTop:15, marginLeft:21}}/>
        ...
        <View style={{flexDirection:'row',width:334,marginLeft:17,height:50,backgroundColor:'white',borderRadius:4,alignSelf:'center',marginTop:30}}>
         ...
         <Button   style={{alignSelf:'center',width:140,height:38,marginLeft:25,backgroundColor:'#FEF2F5',borderRadius:4,borderWidth:1,textAlign:'center'}}><Text style={{fontSize:10,marginLeft:5,fontWeight:'600',color:'#FF4B7D'}}>Charles Adkins</Text></Button>
      


        <Text style={{fontSize:18,marginLeft:25,alignSelf:'center',fontWeight:'600',color:'#A4A4A4'}}>My Meetings</Text> 
        </View>



        <Text style={{marginTop:25,fontSize:18,marginLeft:21,fontWeight:'600',color:'#434343'}}>12 New Referrals this week</Text> 
       
    
        <View style={{width:334,height:293,backgroundColor:'white',borderRadius:10,alignSelf:'center',marginTop:5}}>
