...
render()
{
    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <TouchableOpacity onPress={()=>this.props.navigation.navigate('ViewClientSch')} >  
       <IconAnt4 name="send-circle" size={40} color='#FFAFC5' style={{marginTop:15, marginLeft:270}}/>
        ...
        <Button   style={{marginTop:15,width:200,height:34,marginLeft:10,backgroundColor:'#FEF2F5',borderRadius:4,borderWidth:1,textAlign:'center'}}><Text style={{fontSize:11,alignSelf:'center',fontWeight:'600',color:'#FF4B7D'}}>Recurring Schedule</Text></Button>
          ...
          <View  style={{backgroundColor: '#F3F3F3',width:334,height:50,flexDirection:'row',marginTop:25,alignSelf:'center'}}>
             ...
             <Text style={{fontSize:14,marginLeft:15,fontWeight:'700',color:'#434343'}}>Edit Profile</Text> 
             </View>
           
             <View style={{marginLeft:190,alignSelf:'center'}}>
             <IconAnt3 name="chevron-small-right" size={30} color='#A4A4A4' style={{alignSelf:'center'}}/> 
             </View>
            ...
            <View style={{alignSelf:'center'}}>
            <Text style={{fontSize:14,marginLeft:15,alignSelf:'center',fontWeight:'700',color:'#434343'}}>Skills and Certifications</Text> 
              </View>
            ...
            <View  style={{backgroundColor: '#F3F3F3',width:334,height:50,flexDirection:'row',marginTop:18,alignSelf:'center'}}>
             <Text style={{fontSize:14,marginLeft:15,alignSelf:'center',fontWeight:'700',color:'#434343'}}>Payroll Rates</Text> 
             <IconAnt3 name="chevron-small-right" size={30} color='#A4A4A4' style={{alignSelf:'center',marginLeft:176}}/> 
