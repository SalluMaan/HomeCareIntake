...
import { CareUpdatePasswordPath } from "./constantCaregiver";

YellowBox.ignoreWarnings(["Remote debugger"]);

export default class ResetPassCare extends React.Component {
  ...
  onClickListener = () => {
    ...
    if (
      ...
      axios
        .post(CareUpdatePasswordPath + this.state.id, {
          password: Password,
          c_password: Confirm,
        })
        .then((res) => {
