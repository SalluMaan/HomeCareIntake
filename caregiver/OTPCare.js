...
import { CareOtpVerificationPath } from "./constantCaregiver";

export default class OTPCare extends React.Component {
  ...
  sendCode(code) {
    ...
    axios
      .post(CareOtpVerificationPath, {
        otp: code,
      })
      .then((res) => {
        console.log("Response OTP:", res.data);
        const obj = res.data.success.id;
        // console.log("ID:", obj[0].id);
        res.data.success
          ? this.props.navigation.navigate("ResetPassCare", {
              id: obj,
            })
          : null;
      })
