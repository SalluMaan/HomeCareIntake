...
export default class AddSchdeule extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      selected: this.props.navigation.state.params.schedule.caregiver_id,
      selected2: "",
      date: "",
      caregivers: "",
      client: "",
      timeStart: this.props.navigation.state.params.schedule.timeStart.substring(
        0,
        5
      ),
      time: this.props.navigation.state.params.schedule.date,
      timeEnd: this.props.navigation.state.params.schedule.timeEnd.substring(
        0,
        5
      ),
      response: ".",
  ...
  onClickListener = () => {
    const clientId = this.state.schedule.client_id;
    ...
    if (this.checkEmptyInput() && this.validateDate()) {
      ...
      axios
        .post(
          "https://aplushome.facebhoook.com/api/updateschedule/" +
  ...
  render() {
    ...
    console.log("Props", this.props.navigation.state.params.schedule);
    if (assetsLoaded) {
      return (
