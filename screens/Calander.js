    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <IconAnt name="left" size={20} color='#A4A4A4' style={{marginRight:5}}/>
        ...
        <TouchableOpacity onPress={()=>this.props.navigation.navigate('MsgList')} >
        <Text style={{fontSize:18,marginLeft:20,marginTop:23,fontWeight:'600',color:'#141414'}}>Choose a date from the calendar below</Text>
         </TouchableOpacity>

        <Text>  </Text>
        <Text>  </Text>
        <Text>  </Text>
        <View style={{width:300,backgroundColor:'#F6F6F6',alignSelf:'center'}}>
         <CalendarPicker
