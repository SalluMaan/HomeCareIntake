...
export default class EditSchedule2 extends React.Component{
    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <IconAnt name="left" size={20} color='#A4A4A4' style={{marginRight:5}}/>
        ...
        <TouchableOpacity onPress={()=>this.props.navigation.navigate('RecurringSchedule2')} >
       
        <Text style={{fontSize:18,marginLeft:20,marginTop:23,fontWeight:'600',color:'#141414'}}>Edit Schedule</Text>
        </TouchableOpacity>
