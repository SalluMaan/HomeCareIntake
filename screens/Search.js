    ...
    if( assetsLoaded ) 
    {
      return(<View style={styles.container}>
       ...
       <IconAnt name="left" size={20} color='#A4A4A4' style={{marginRight:5}}/>
        ...
        <IconAnt2 name="radio-btn-active" size={20} color='#FF4B7D' style={{marginLeft:20,marginTop:23}}/>
        <Text style={{fontSize:12,marginLeft:26,marginTop:23,fontWeight:'600',color:'#FF4B7D'}}>Clients</Text>
       

        <IconAnt2 name="radio-btn-passive" size={20} color='#A4A4A4' style={{marginLeft:20,marginTop:23}}/>
       <Text style={{fontSize:12,marginLeft:26,marginTop:23,fontWeight:'600',color:'#A4A4A4'}}>Caregivers</Text>
        </View>
        </TouchableOpacity>
