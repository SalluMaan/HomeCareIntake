...
var chosenDate = "";
var newDate = "";
export default class ViewCaregiverSch extends React.Component {
  ...
  getData = () => {
    ...
    formData.append("caregiver_id", this.state.user.id);
    formData.append("intakeco_id", this.state.user.intakeco_id);
    console.log("Data", formData);
    axios
      .post(`https://aplushome.facebhoook.com/api/getschedule`, formData)
      .then((res) => {
        console.log("Name", res.data["schedule"]);
                  ...
                  <View key={id}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {user.name ? user.name : "Name not taken"}{" "}
                        </Text>
                        <View
                          style={{
                            flexDirection: "row",
